...
# importing for class based APIView
...
class ArticleViewSet(viewsets.ModelViewSet):
    ...
    # passed indivisually in perticular view set which we dont want to show without auth
...
class ArticleDetails(generics.GenericAPIView, mixins.RetrieveModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin):
    ...
    lookup_field = 'id'  # used to chnage id to pk whrn mixin
...
'''
#for class based api view without  mixin
